...
Referência completa dos papéis existentes na stream, com responsabilidades, DO e DON'T. O AC deve conhecer estes limites para capacitar sem substituir.
...
- Dar visibilidade aos temas transversais e organizacionais para o AAC.
...
- Ajudar a equipa a clarificar propósito, valor e impacto das entregas.
- Apoiar PMs na maximização de valor e gestão do product backlog.
- Apoiar na gestão de dependências entre equipas.
...
- Ser o único que remove os impedimentos da equipa.
- Organizar o onboarding de novas pessoas na equipa ou na stream.

> O SAC é responsável por desenvolver equipas autónomas e com foco na entrega de valor, promovendo um fluxo de entrega eficiente e previsível através da evolução e adoção de práticas ágeis orientadas a resultados.
...
- Colaborar com PMs e PjM na conceção de soluções.
- Liderar tecnicamente a equipa, atuando como referência.
...
- Criar/registar a(s) Iniciativa(s) no Jira para aprovação e inserção no ciclo de trabalho.
- As US criadas pelo PM devem conter: Título, Descrição clara e objetiva e Critérios de Aceitação.
- Acompanhar continuamente as interações dos clientes e analisar dados dos utilizadores.
- Facilita as sessões de Refinement de Backlog, Review e Planning.
- Orquestra o processo de Modelo de Suporte.
- Orquestra funcionalmente com outras equipas de produto o processo de Change Enablement (aspeto funcional).
...
## Equipa de Desenvolvimento (Dev Team)
...
- Auto-organizar-se. Ninguém (nem mesmo o SAC) diz aos Developers como transformar o Product Backlog em incrementos utilizáveis.
...
- Identificar e reportar erros.
- Participar nos ciclos de feedback.
- Monitorizar e validar a experiência do utilizador.
- Acompanhar testes em ambiente de homologação e produção.
